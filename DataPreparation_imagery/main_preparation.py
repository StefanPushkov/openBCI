from DataPreparation_imagery.txt_to_csv import text_to_csv
from DataPreparation_imagery.auto_markup import auto_markup
from DataPreparation_imagery.to_txt import convert_to_txt
from DataPreparation_imagery.hex_to_dec import hex_to_dec
import config as cf
import os


final_directory = cf.base_dir+"/prepared_data_imagery"
dir_for_converted_data = cf.base_dir+"/converted_data"
raw_data = cf.base_dir+cf.raw_data_imagery_V
...
# Merging to one
data_processing(raw_data=raw_data, num_new=cf.num_imagery_V, out_dir=final_directory)
