...
prepared_data_3min_vs = 'c:/Storage/Mark/openBCI/openBCI/prepared_data_3min/decimal2B.csv'
prepared_data_15min_vs = 'c:/Storage/Mark/openBCI/openBCI/prepared_data_15min/decimal29.csv'
